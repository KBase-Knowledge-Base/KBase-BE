...
- `docs/exec-plans/KBase_Core_v1_Implementation_Plan.md`: master roadmap của KBase Core v1; giữ dependency và milestone toàn dự án, không dùng thay active slice của phiên hiện tại
...
- Master roadmap giữ toàn bộ dependency; agent nên làm việc từ một active slice nhỏ và quay lại master plan khi cần dependency hoặc milestone context.

...
- **AI v1 active:** `KBase_AI_Chatbot_v1_M2_PgVector_AI_Persistence_Schema.md` — M1 đã PASS và được lưu trong `../completed/`; M2 triển khai schema/persistence theo SD-16, chưa mở worker, provider, retrieval hoặc public API.

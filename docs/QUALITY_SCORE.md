...
| AI Chatbot / RAG | B+ | M0–M10 evidence: strict Project RAG/private API/retention, immutable two-source Guide corpus, SQL-bound allowlist, Redis per-user usage guard, stable 429/503 errors, retrieval threshold `0.70`, bounded observability and exact runtime OpenAPI; M10 final full gate 371/371 | Cao ở application/REST boundary, corpus isolation, guard contract và source docs | Full provider-backed Docker golden journey/restart recovery thuộc M11; real Gemini smoke absent; M5 worker lease heartbeat còn là debt | 2026-09-25 |
...
|---|---|---|---|---|
| Backend | A | M0–M16 Core implementation/maintenance + M1–M10 AI foundation, indexing, strict RAG, private REST, retention and usage/contract hardening verified; Core v1 frozen; full 371/371 | M11 full runtime/freeze evidence remains | 2026-09-25 |
| AI / RAG | B+ | M6 real pgvector trap/grounding, M7 PostgreSQL/JWT conversation lifecycle, M8 retention, M9 Guide allowlist and M10 Redis guard/threshold/observability/OpenAPI hardening; targeted M10 suites pass, full 371/371 | M11 provider-backed Docker runtime/restart freeze and real Gemini connectivity chưa có | 2026-09-25 |
...
| Tích hợp hệ thống | A | Core Docker runtime smoke + M1–M10 Testcontainers/fakes: PostgreSQL 17.11 pgvector, Redis 7.4 guard, V1–V4, index/RAG/conversation lifecycle, JWT privacy, in-flight revoke, OpenAPI and full regression 371/371; no public provider network | Gmail thật manual smoke và real Gemini connectivity/Compose AI journey chưa chạy | 2026-09-25 |
| Kiểm thử | A | M10 targeted guard/observability/Guide/OpenAPI suites plus full `mvn -B -ntp clean verify` 371/371; real Redis/PostgreSQL/JWT/concurrency/OpenAPI cases and bounded-tag/privacy assertions; Core regression retained | Docker AI golden journey/restart smoke thuộc M11; Docker smoke chưa script hóa | 2026-09-25 |
| Thiết lập development | A | `docker compose` config + Testcontainers pgvector 0.8.6/PostgreSQL 17.11/Redis 7.4 verified; V4 fresh/upgrade, M3 lifecycle, M4 provider, M5 extraction/indexing, M10 guard/OpenAPI commands, reset/start commands và generated DB schema tài liệu hóa; AI disabled mặc định | Full real-provider/AI indexing Compose runtime chưa verify; Gmail thật chưa verify | 2026-09-25 |
| Reliability | A | Core golden journeys trong Docker runtime (M14/M15), M3 durable job/document/retention races, M5 bounded index lifecycle, M7 short-TX conversation/provider failure/revoke/delete races, M10 fail-closed guard and bounded telemetry pass; full 371/371 | No lease heartbeat during long M5 work; abrupt process death can leave chat PROCESSING until M11 recovery verification/policy; no real provider runtime smoke | 2026-09-25 |
| Deployment và rollback | A | M14/M15 Dockerfile + Compose/runtime verification; M1 healthcheck topology, M2 additive V4 policy, M4 disabled-by-default provider configuration/request-timeout, M5 no-topology/no-migration change, M10 usage/threshold env passthrough and Compose config pass | Real Gemini deployment/connectivity chưa verify; connect-timeout SDK limitation, M5 lease limitation and M11 AI runtime freeze tracked; chưa có production deployment target | 2026-09-25 |

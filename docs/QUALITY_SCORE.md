...
| AI Chatbot / RAG | - | M0 Gate PASS với Core 213/213, Spring AI/Gemini options probe, pgvector Docker probe, Tika dependency probe và harness revalidation; chưa có runtime code/schema/API/test evidence | Cao ở mức source docs và M0 decision log; implementation chưa tồn tại | Chưa chấm test stability | M1–M11 runtime implementation và AI behavior verification chưa chạy; real Gemini smoke intentionally absent | 2026-09-22 |
...
| AI / RAG | - | Product/design sources + M0–M11 master plan; M0 đã khóa exact Spring AI 2.0.1/Gemini models, pgvector image/JDBC, Tika scope, config baseline và deterministic fake contracts bằng executable probes | Chưa có Spring AI/Gemini/pgvector/jobs/conversation/Guide runtime; M1–M11 chưa implement; real Gemini chưa gọi | 2026-09-22 |

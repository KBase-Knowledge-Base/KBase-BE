...
| API contract | A | M7 runtime OpenAPI exact 37 paths/56 operations, 14 tags, 20 contract tests including AI methods/request/response schemas, bearer/errors/sensitive-field scan; generated Markdown synchronized | Markdown snapshot sync thủ công; chưa có snapshot/breaking-change CI diff (optional theo SD-11) | 2026-09-24 |
